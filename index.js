...
global.prefix = new RegExp('^[!]') // ✅ Prefijo cambiado a !
...
// ✅ CORRECCIÓN CRÍTICA - IMPORTACIÓN DEL HANDLER
let handler
try {
  const handlerModule = await import('./handler.js')
  handler = handlerModule.handler || handlerModule.default || handlerModule
} catch (e) {
...
global.reloadHandler = async function (restatConn) {
  try {
    ...
    if (Handler && (Handler.handler || Handler.default || Handler)) {
      handler = Handler.handler || Handler.default || Handler
    }
  } catch (e) {
    console.error(e)
  }
